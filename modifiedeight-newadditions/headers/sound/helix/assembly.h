...
/*  toolchain:           x86 gcc
    target architecture: x86
*/
#elif defined(__GNUC__) && (defined(__i386__) || defined(__amd64__) || defined(__x86_64__) || defined(__aarch64__) || defined(__arm__)) || (defined (_SOLARIS) && !defined (__GNUC__) && defined(_SOLARISX86))
