...
struct Options{
	struct Option
	{
		...
		static Options::Option NEW_ADDITIONS;
		static Options::Option SPRINT;
		...
		static Options::Option MARKETPLACE;
		static Options::Option FOG_ENABLED;
	...
	bool_t showCoordinates;
	bool_t classicTextures;
	bool_t marketplace;
	bool_t fogEnabled;
	bool_t showFps;
	bool_t debugScreen;
