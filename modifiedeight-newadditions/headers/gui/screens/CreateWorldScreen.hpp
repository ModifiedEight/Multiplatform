...
struct CreateWorldScreen : SelectWorldScreen {
  ...
  ImageButton *worldTypeOldButton;
  ImageButton *worldTypeInfButton;
  ImageButton *worldTypeFlatButton;
  Button *selectedWorldType;
  Label *worldTypeLabel;
  Button *btnAdvancedSettings;
  Button *btnMoreOptions;
  Button *btnCaves;
  Button *btnMonsters;
  Button *btnAnimals;
  Button *btnTimeFreeze;
  int32_t currentTab;
  bool_t optCaves;
  bool_t optMonsters;
  bool_t optAnimals;
  bool_t optTimeFreeze;
