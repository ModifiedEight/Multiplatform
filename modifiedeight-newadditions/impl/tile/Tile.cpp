...
Tile *Tile::sponge;
Tile *Tile::glass;
Tile *Tile::stainedGlass;
Tile *Tile::stainedGlassPane;
Tile *Tile::lapisOre;
...
Tile *Tile::deadBush;
Tile *Tile::cloth;
Tile *Tile::coloredPlanks;
Tile *Tile::coloredBricks;
Tile *Tile::coloredStairs[16];
Tile *Tile::coloredFences[16];
Tile *Tile::coloredLogs[16];
Tile *Tile::coloredSlabHalf1;
Tile *Tile::coloredSlab1;
Tile *Tile::coloredSlabHalf2;
Tile *Tile::coloredSlab2;
Tile *Tile::coloredBrickStairs[16];
Tile *Tile::coloredBrickSlabHalf1;
...
Tile *Tile::dirtSlab;
Tile *Tile::dirtSlabHalf;
Tile *Tile::grassSlab;
Tile *Tile::grassSlabHalf;
Tile *Tile::rockSlab;
Tile *Tile::rockSlabHalf;
Tile *Tile::redBrick;
Tile *Tile::tnt;
Tile *Tile::bookshelf;
Tile *Tile::mossStone;
...
Tile *Tile::sign;
Tile *Tile::door_wood;
Tile *Tile::door_spruce;
Tile *Tile::door_birch;
Tile *Tile::ladder;
Tile *Tile::rail;
Tile *Tile::stairs_stone;
Tile *Tile::wallSign;
Tile *Tile::door_iron;
Tile *Tile::pressurePlateStone;
Tile *Tile::pressurePlatePlanks;
Tile *Tile::pressurePlate_cobblestone;
Tile *Tile::pressurePlate_spruce;
Tile *Tile::pressurePlate_birch;
Tile *Tile::pressurePlate_jungle;
...
void Tile::initTiles(std::shared_ptr<TextureAtlas> a1) {
  ...
  Tile::rock = (new StoneTile(1, "stone"))
                   ->init()
                   ->setDestroyTime(1)
  ...
  Tile::grassPath = (new GrassPathTile(250))
                        ->init()
                        ->setDestroyTime(0.6f)
                        ->setSoundType(Tile::SOUND_GRASS)
                        ->setCategory(1, 1)
                        ->setDescriptionId("grassPath");
  Tile::dirt = (new DirtTile(3, "dirt", Material::dirt))
                   ->init()
                   ->setDestroyTime(0.5f)
  ...
  Tile::stoneBrick = (new Tile(4, "cobblestone", Material::stone))
                         ->init()
                         ->setDestroyTime(2.0)
                         ->setExplodeable(10.0)
                         ->setSoundType(Tile::SOUND_STONE)
  ...
  Tile::sapling = (new Sapling(6, "sapling"))
                      ->init()
                      ->setDestroyTime(0)
                      ->setSoundType(Tile::SOUND_GRASS)
                      ->setCategory(2, 1)
                      ->setDescriptionId("sapling");
  Tile::unbreakable = (new Tile(7, "bedrock", Material::stone))
                          ->init()
                          ->setDestroyTime(-1.0)
  ...
  Tile::water = (new LiquidTileDynamic(8, Material::water, "still_water",
                                       "flowing_water"))
                    ->init()
                    ->setDestroyTime(100)
                    ->setLightBlock(3)
  ...
  Tile::calmWater =
      (new LiquidTileStatic(9, Material::water, "still_water", "flowing_water"))
          ->init()
          ->setDestroyTime(100)
          ->setLightBlock(3)
          ->setCategory(1, 1)
          ->setDescriptionId("water");
  Tile::lava =
      (new LiquidTileDynamic(10, Material::lava, "still_lava", "flowing_lava"))
          ->init()
          ->setDestroyTime(0)
  ...
  Tile::calmLava =
      (new LiquidTileStatic(11, Material::lava, "still_lava", "flowing_lava"))
          ->init()
  ...
  Tile::sand = (new HeavyTile(12, "sand"))
                   ->init()
                   ->setDestroyTime(0.5)
  ...
  Tile::gravel = (new GravelTile(0xD, "gravel"))
                     ->init()
                     ->setDestroyTime(0.6)
                     ->setSoundType(Tile::SOUND_GRAVEL)
                     ->setCategory(1, 1)
                     ->setDescriptionId("gravel");
  Tile::goldOre = (new OreTile(14, "gold_ore"))
                      ->init()
                      ->setDestroyTime(3.0)
                      ->setExplodeable(5.0)
                      ->setSoundType(Tile::SOUND_STONE)
  ...
  Tile::ironOre = (new OreTile(15, "iron_ore"))
                      ->init()
                      ->setDestroyTime(3.0)
                      ->setExplodeable(5.0)
                      ->setSoundType(Tile::SOUND_STONE)
  ...
  Tile::coalOre = (new OreTile(16, "coal_ore"))
                      ->init()
                      ->setDestroyTime(3.0)
                      ->setExplodeable(5.0)
                      ->setSoundType(Tile::SOUND_STONE)
  ...
  Tile::leaves = (new LeafTile(18, "leaves"))
                     ->init()
                     ->setDestroyTime(0.2)
                     ->setLightBlock(1)
                     ->setSoundType(Tile::SOUND_GRASS)
  ...
  Tile::glass = (new GlassTile(20, "glass", Material::glass))
                    ->init()
                    ->setDestroyTime(0.3)
  ...
  Tile::stainedGlass =
      (new StainedGlassTile(195, "glass_white", Material::glass))
          ->init()
          ->setDestroyTime(0.3)
          ->setSoundType(Tile::SOUND_GLASS)
          ->setCategory(5, 1)
          ->setDescriptionId("stainedGlass");
  Tile::stainedGlassPane =
      (new StainedGlassPaneTile(196, "glass_white", "glass_pane_top_shared",
                                Material::glass, 0))
          ->init()
          ->setDestroyTime(0.3)
          ->setSoundType(Tile::SOUND_GLASS)
          ->setCategory(5, 1)
          ->setDescriptionId("stainedGlassPane");
  Tile::lapisOre = (new OreTile(21, "lapis_ore"))
                       ->init()
                       ->setDestroyTime(3.0)
                       ->setExplodeable(5.0)
                       ->setSoundType(Tile::SOUND_STONE)
  ...
  Tile::lapisBlock = (new Tile(22, "lapis_block", Material::stone))
                         ->init()
                         ->setDestroyTime(3.0)
                         ->setExplodeable(5.0)
                         ->setSoundType(Tile::SOUND_STONE)
  ...
  Tile::sandStone = (new SandStoneTile(24, "sandstone"))
                        ->init()
                        ->setSoundType(Tile::SOUND_STONE)
                        ->setDestroyTime(0.8)
                        ->setCategory(1, 1)
  ...
  Tile::web = (new WebTile(30, "web", Material::web))
                  ->init()
                  ->setLightBlock(1)
                  ->setDestroyTime(4.0)
                  ->setCategory(2, 8)
                  ->setDescriptionId("web");
  Tile::tallgrass = (new TallGrass(31, "tallgrass"))
                        ->init()
                        ->setDestroyTime(0)
                        ->setSoundType(Tile::SOUND_GRASS)
                        ->setCategory(2, 8)
                        ->setDescriptionId("tallgrass");
  Tile::deadBush = (new DeadBush(32, "tallgrass"))
                       ->init()
                       ->setDestroyTime(0)
                       ->setSoundType(Tile::SOUND_GRASS)
                       ->setCategory(2, 1)
                       ->setDescriptionId("deadbush");
  Tile::cloth = (new ClothTile(35))
                    ->init()
                    ->setDestroyTime(0.8)
                    ->setSoundType(Tile::SOUND_CLOTH)
                    ->setCategory(2, 1)
                    ->setDescriptionId("cloth");
  Tile::coloredPlanks = (new ColoredPlanksTile(217))
                            ->init()
                            ->setDestroyTime(2.0)
                            ->setExplodeable(5.0)
                            ->setSoundType(Tile::SOUND_WOOD)
                            ->setCategory(6, 1)
                            ->setDescriptionId("coloredPlanks");
  Tile::coloredBricks = (new ColoredBricksTile(238))
                            ->init()
                            ->setDestroyTime(2.0)
                            ->setExplodeable(10.0)
                            ->setSoundType(Tile::SOUND_STONE)
                            ->setCategory(6, 1)
                            ->setDescriptionId("coloredBricks");
  Tile::flower = (new FlowerTile(37, "flower_dandelion"))
                     ->init()
                     ->setDestroyTime(0)
                     ->setSoundType(Tile::SOUND_GRASS)
                     ->setCategory(2, 8)
                     ->setDescriptionId("flower");
  Tile::rose = (new FlowerTile(38, "flower_rose_blue"))
                   ->init()
                   ->setDestroyTime(0)
                   ->setSoundType(Tile::SOUND_GRASS)
                   ->setCategory(2, 8)
                   ->setDescriptionId("rose");
  Tile::doublePlant = (new DoublePlantTile(190, "double_plant"))
                          ->init()
                          ->setDestroyTime(0)
                          ->setSoundType(Tile::SOUND_GRASS)
                          ->setCategory(2, 8)
                          ->setDescriptionId("doublePlant");
  Tile::flowerPaeonia = (new FlowerTile(191, "flower_paeonia"))
                            ->init()
                            ->setDestroyTime(0)
                            ->setSoundType(Tile::SOUND_GRASS)
                            ->setCategory(2, 8)
                            ->setDescriptionId("flowerPaeonia");
  Tile::flowerDaisy = (new FlowerTile(192, "flower_oxeye_daisy"))
                          ->init()
                          ->setDestroyTime(0)
                          ->setSoundType(Tile::SOUND_GRASS)
                          ->setCategory(2, 8)
                          ->setDescriptionId("flowerDaisy");
  Tile::flowerHoustonia = (new FlowerTile(239, "flower_houstonia"))
                              ->init()
                              ->setDestroyTime(0)
                              ->setSoundType(Tile::SOUND_GRASS)
                              ->setCategory(2, 8)
                              ->setDescriptionId("flowerHoustonia");
  Tile::flowerOrchid = (new FlowerTile(240, "flower_blue_orchid"))
                           ->init()
                           ->setDestroyTime(0)
                           ->setSoundType(Tile::SOUND_GRASS)
                           ->setCategory(2, 8)
                           ->setDescriptionId("flowerOrchid");
  Tile::flowerAllium = (new FlowerTile(241, "flower_allium"))
                           ->init()
                           ->setDestroyTime(0)
                           ->setSoundType(Tile::SOUND_GRASS)
                           ->setCategory(2, 8)
  ...
  Tile::vine = (new VineTile(106, "vine"))
                   ...
                   ->setSoundType(Tile::SOUND_GRASS)
                   ->setCategory(2, 8)
                   ->setDescriptionId("vine");
  Tile::waterLily = (new WaterLilyTile(111, "waterlily"))
                        ->init()
                        ->setDestroyTime(0.0f)
                        ->setSoundType(Tile::SOUND_GRASS)
                        ->setCategory(2, 8)
                        ->setDescriptionId("waterlily");
  Tile::solid[111] = 0;
  Tile::lightBlock[111] = 0;
  Tile::seagrass = (new SeagrassTile(252, "seagrass"))
                       ->init()
                       ->setDestroyTime(0.0f)
                       ->setSoundType(Tile::SOUND_GRASS)
                       ->setCategory(2, 8)
  ...
  Tile::mushroom1 = (new Mushroom(39, "mushroom_brown"))
                        ->init()
                        ->setDestroyTime(0)
                        ->setSoundType(Tile::SOUND_GRASS)
  ...
  Tile::mushroom2 = (new Mushroom(40, "mushroom_red"))
                        ->init()
                        ->setDestroyTime(0)
                        ->setSoundType(Tile::SOUND_GRASS)
                        ->setCategory(2, 8)
  ...
  Tile::ironBlock = (new MetalTile(42, "iron_block"))
                        ->init()
                        ->setDestroyTime(5.0)
                        ->setExplodeable(10.0)
                        ->setSoundType(Tile::SOUND_METAL)
  ...
  Tile::stoneSlab = (new StoneSlabTile(43, 1))
                        ->init()
                        ->setDestroyTime(2.0)
                        ->setExplodeable(10.0)
                        ->setSoundType(Tile::SOUND_STONE)
  ...
  Tile::stoneSlabHalf = (new StoneSlabTile(44, 0))
                            ->init()
                            ->setDestroyTime(2.0)
                            ->setExplodeable(10.0)
                            ->setSoundType(Tile::SOUND_STONE)
                            ->setCategory(1, 1)
                            ->setDescriptionId("stoneSlab");
  Tile::mixedSlab = (new MixedSlabTile(251))
                        ->init()
                        ->setDestroyTime(2.0f)
                        ->setExplodeable(10.0f)
                        ->setSoundType(Tile::SOUND_STONE)
                        ->setDescriptionId("mixedSlab");
  Tile::redBrick = (new Tile(45, "brick", Material::stone))
                       ->init()
                       ->setDestroyTime(2.0)
                       ->setExplodeable(10.0)
                       ->setSoundType(Tile::SOUND_STONE)
  ...
  Tile::tnt = (new TntTile(46, "tnt_side"))
                  ->init()
                  ->setDestroyTime(0.0)
                  ->setSoundType(Tile::SOUND_GRASS)
                  ->setCategory(2, 1)
  ...
  Tile::fence_spruce = (new SpruceFenceTile(197))
                           ->init()
                           ->setDestroyTime(2.0)
                           ->setExplodeable(5.0)
                           ->setSoundType(Tile::SOUND_WOOD)
                           ->setCategory(5, 1)
                           ->setDescriptionId("fence_spruce");
  Tile::fence_birch = (new BirchFenceTile(198))
                          ->init()
                          ->setDestroyTime(2.0)
                          ->setExplodeable(5.0)
                          ->setSoundType(Tile::SOUND_WOOD)
                          ->setCategory(5, 1)
                          ->setDescriptionId("fence_birch");

  Tile::trapdoor_spruce =
      (new TrapDoorTile(199, "trapdoor_spruce", Material::wood))
          ->init()
          ->setDestroyTime(3.0)
          ->setSoundType(Tile::SOUND_WOOD)
          ->setCategory(5, 1)
          ->setDescriptionId("trapdoor_spruce");
  Tile::trapdoor_birch =
      (new TrapDoorTile(200, "trapdoor_birch", Material::wood))
          ->init()
          ->setDestroyTime(3.0)
          ->setSoundType(Tile::SOUND_WOOD)
          ->setCategory(5, 1)
  ...
  Tile::mossStone = (new Tile(48, "cobblestone_mossy", Material::stone))
                        ->init()
                        ->setDestroyTime(2.0)
                        ->setExplodeable(10.0)
                        ->setSoundType(Tile::SOUND_STONE)
  ...
  Tile::obsidian = (new ObsidianTile(49, "obsidian", 0))
                       ->init()
                       ->setDestroyTime(10)
                       ->setExplodeable(2000)
                       ->setSoundType(Tile::SOUND_STONE)
  ...
  Tile::torch = (new TorchTile(50, "torch_on", Material::decoration))
                    ->init()
                    ->setDestroyTime(0)
  ...
  Tile::chest = (new ChestTile(54))
                    ->init()
                    ->setCategory(2, 1)
                    ->setDestroyTime(2.5)
                    ->setSoundType(Tile::SOUND_WOOD)
                    ->setDescriptionId("chest");
  Tile::emeraldOre = (new OreTile(56, "diamond_ore"))
                         ->init()
                         ->setDestroyTime(3.0)
                         ->setExplodeable(5.0)
                         ->setSoundType(Tile::SOUND_STONE)
  ...
  Tile::emeraldBlock = (new MetalTile(57, "diamond_block"))
                           ->init()
                           ->setDestroyTime(5.0)
                           ->setExplodeable(10.0)
                           ->setSoundType(Tile::SOUND_METAL)
  ...
  Tile::crops = (new CropTile(59, "wheat_stage_x"))
                    ->init()
                    ->setDestroyTime(0)
                    ->setSoundType(Tile::SOUND_GRASS)
                    ->setCategory(4, 1)
  ...
  Tile::furnace = (new FurnaceTile(61, 0))
                      ->init()
                      ->setDestroyTime(3.5)
                      ->setSoundType(Tile::SOUND_STONE)
                      ->setCategory(2, 1)
                      ->setDescriptionId("furnace");
  Tile::furnace_lit = (new FurnaceTile(62, 1))
                          ->init()
                          ->setDestroyTime(3.5)
                          ->setSoundType(Tile::SOUND_STONE)
  ...
  Tile::door_spruce = (new DoorTile(193, Material::wood, "door_spruce"))
                          ->init()
                          ->setDestroyTime(3.0)
                          ->setSoundType(Tile::SOUND_WOOD)
                          ->setCategory(2, 1)
                          ->setDescriptionId("doorSpruce");
  Tile::door_birch = (new DoorTile(194, Material::wood, "door_birch"))
                         ->init()
                         ->setDestroyTime(3.0)
                         ->setSoundType(Tile::SOUND_WOOD)
                         ->setCategory(2, 1)
                         ->setDescriptionId("doorBirch");
  ...
  Tile::wallSign = (new SignTile(68, 0))
                       ->init()
                       ->setDestroyTime(1.0)
                       ->setSoundType(Tile::SOUND_WOOD)
                       ->setCategory(2, 8)
  ...
  Tile::pressurePlateStone =
      (new PressurePlateTile(70, Tile::getTextureUVCoordinateSet("stone", 0),
                             Material::stone))
          ->init()
          ->setDestroyTime(0.5f)
          ->setSoundType(Tile::SOUND_STONE)
  ...
  Tile::pressurePlate_gold =
      (new PressurePlateTile(147,
                             Tile::getTextureUVCoordinateSet("gold_block", 0),
                             Material::metal))
          ->init()
          ->setDestroyTime(0.5f)
          ->setSoundType(Tile::SOUND_METAL)
  ...
  Tile::pressurePlate_iron =
      (new PressurePlateTile(148,
                             Tile::getTextureUVCoordinateSet("iron_block", 0),
                             Material::metal))
          ->init()
          ->setDestroyTime(0.5f)
          ->setSoundType(Tile::SOUND_METAL)
  ...
  Tile::redstoneLampOn = (new RedstoneLampTile(124, 1))
                             ->init()
                             ->setDestroyTime(0.3f)
                             ...
                             ->setCategory(2, 1)
                             ->setDescriptionId("redstoneLamp");
  Tile::redStoneOre = (new RedStoneOreTile(73, "redstone_ore", 0))
                          ->init()
                          ->setDestroyTime(3.0)
                          ->setExplodeable(5.0)
                          ->setSoundType(Tile::SOUND_STONE)
  ...
  Tile::redStoneOre_lit = (new RedStoneOreTile(74, "redstone_ore", 1))
                              ->init()
                              ->setDestroyTime(3.0)
                              ...
                              ->setCategory(2, 8)
                              ->setDescriptionId("oreRedstone");
  Tile::topSnow = (new TopSnowTile(78, "snow", Material::topSnow))
                      ->init()
                      ->setDestroyTime(0.1)
                      ->setSoundType(Tile::SOUND_CLOTH)
                      ->setCategory(2, 1)
                      ->setDescriptionId("snow");
  Tile::ice = (new IceTile(79, "ice", Material::ice))
                  ->init()
                  ->setDestroyTime(0.5)
                  ->setLightBlock(3)
                  ->setSoundType(Tile::SOUND_GLASS)
  ...
  Tile::snow = (new SnowTile(80, "snow", Material::snow))
                   ->init()
                   ->setDestroyTime(0.2)
                   ->setSoundType(Tile::SOUND_CLOTH)
                   ->setCategory(1, 1)
  ...
  Tile::clay = (new ClayTile(82, "clay", Material::clay))
                   ->init()
                   ->setDestroyTime(0.6)
                   ->setSoundType(Tile::SOUND_GRAVEL)
                   ->setCategory(1, 1)
                   ->setDescriptionId("clay");
  Tile::reeds = (new ReedTile(83, "reeds", Material::plant))
                    ->init()
                    ->setDestroyTime(0)
                    ->setSoundType(Tile::SOUND_GRASS)
                    ->setCategory(2, 1)
                    ->setDescriptionId("reeds");
  Tile::fence = (new FenceTile(85, "planks", Material::wood))
                    ->init()
                    ->setDestroyTime(2.0)
                    ->setExplodeable(5.0)
                    ->setSoundType(Tile::SOUND_WOOD)
  ...
  Tile::pumpkin = (new PumpkinTile(86, 0))
                      ->init()
                      ->setDestroyTime(1.0)
                      ->setSoundType(Tile::SOUND_WOOD)
                      ->setCategory(2, 1)
                      ->setDescriptionId("pumpkin");
  Tile::netherrack = (new Tile(87, "netherrack", Material::stone))
                         ->init()
                         ->setDestroyTime(0.4)
                         ->setSoundType(Tile::SOUND_STONE)
                         ->setCategory(1, 1)
  ...
  Tile::cake = (new CakeTile(92))
                   ...
                   ->setCategory(2, 4);
  Tile::invisible_bedrock = (new InvisibleTile(95, "stone", Material::stone))
                                ->init()
                                ->setDestroyTime(-1.0)
                                ->setExplodeable(6000000.0);
  ...
  Tile::stoneBrickSmooth =
      (new MultiTextureTile(98, "stonebrick", Material::stone))
          ->init()
          ->setDestroyTime(1.5)
          ->setExplodeable(10.0)
          ->setSoundType(Tile::SOUND_STONE)
  ...
  Tile::ironFence =
      (new ThinFenceTile(101, "iron_bars", "iron_bars", Material::metal, 1))
          ->init()
          ->setDestroyTime(5.0)
          ->setExplodeable(10.0)
          ->setSoundType(Tile::SOUND_METAL)
          ->setCategory(2, 8)
          ->setDescriptionId("fenceiro"); // iro > iron
  Tile::thinGlass =
      (new ThinFenceTile(102, "glass", "glass_pane_top", Material::glass, 0))
          ->init()
          ->setDestroyTime(0.3)
          ->setSoundType(Tile::SOUND_GLASS)
          ->setCategory(2, 1)
  ...
  Tile::melonStem = (new StemTile(105, Tile::melon))
                        ...
                        ->setDescriptionId("pumpkinStem");
  Tile::fenceGate =
      (new FenceGateTile(107, "planks", Material::wood))
          ->init()
          ->setDestroyTime(2.0)
          ->setExplodeable(5.0)
          ->setSoundType(Tile::SOUND_WOOD)
          ->setCategory(2, 1)
          ->setDescriptionId(
              "fenceGate"); // TODO "planks" is inside the constructor?
  Tile::stairs_brick = (new StairTile(108, Tile::redBrick, 0))
                           ->init()
                           ->setCategory(1, 1)
                           ->setDescriptionId("stairsBrick");
  Tile::woodStairsDark = (new StairTile(134, Tile::wood, 1))
                             ->init()
                             ->setCategory(1, 1)
                             ->setDescriptionId("stairsWoodSpruce");
  Tile::woodStairsBirch = (new StairTile(135, Tile::wood, 2))
                              ->init()
                              ->setCategory(1, 1)
                              ->setDescriptionId("stairsWoodBirch");
  Tile::woodStairsJungle = (new StairTile(136, Tile::wood, 3))
                               ->init()
                               ->setCategory(1, 1)
                               ->setDescriptionId("stairsWoodJungle");
  Tile::stairs_stoneBrickSmooth =
      (new StairTile(109, Tile::stoneBrickSmooth, 0))
          ->init()
          ->setCategory(1, 1)
          ->setDescriptionId("stairsStoneBrickSmooth");
  Tile::netherBrick = (new Tile(112, "nether_brick", Material::stone))
                          ->init()
                          ->setDestroyTime(2.0)
                          ->setExplodeable(10.0)
                          ->setSoundType(Tile::SOUND_STONE)
  ...
  Tile::stairs_netherBricks = (new StairTile(114, Tile::netherBrick, 0))
                                  ->init()
                                  ->setCategory(1, 1)
                                  ->setDescriptionId("stairsNetherBrick");
  Tile::activatorRail = (new CakeTile(126))
                            ->init()
                            ->setDestroyTime(0.5)
                            ->setSoundType(Tile::SOUND_CLOTH)
                            ->setDescriptionId("cake")
  ...
  Tile::stairs_quartz = (new StairTile(156, Tile::quartzBlock, 0))
                            ->init()
                            ->setCategory(1, 1)
  ...
  Tile::woodSlab = (new WoodSlabTile(157, 1))
                       ...
                       ->setSoundType(Tile::SOUND_WOOD)
                       ->setCategory(1, 1)
                       ->setDescriptionId("woodSlab");
  Tile::woodSlabHalf = (new WoodSlabTile(158, 0))
                           ->init()
                           ->setDestroyTime(2.0)
                           ->setExplodeable(10.0)
                           ->setSoundType(Tile::SOUND_WOOD)
  ...
  Tile::woolCarpet = (new WoolCarpetTile(171))
                         ...
                         ->setCategory(2, 8)
                         ->setLightBlock(0)
                         ->setDescriptionId("woolCarpet");
  Tile::coalBlock = (new MetalTile(173, "coal_block"))
                        ->init()
                        ->setDestroyTime(5.0)
                        ->setExplodeable(10.0)
                        ->setSoundType(Tile::SOUND_STONE)
                        ->setCategory(2, 8)
                        ->setDescriptionId("blockCoal");
  Tile::coalBlock->field_5C = 255;
  Tile::beetroot = (new BeetrootTile(244))
                       ->init()
                       ->setDestroyTime(0)
                       ->setCategory(2, 4)
                       ->setDescriptionId("beetroot");
  Tile::stonecutterBench = (new StonecutterTile(245))
                               ->init()
                               ->setDestroyTime(2.5)
                               ->setSoundType(Tile::SOUND_STONE)
                               ->setCategory(2, 1)
  ...
  Tile::netherReactor =
      (new NetherReactor(247, "reactor_core_stage_x", Material::metal))
          ->init()
          ->setDestroyTime(3.0)
          ->setSoundType(Tile::SOUND_METAL)
          ->setCategory(2, 1)
          ->setDescriptionId("netherreactor");
  Tile::info_updateGame1 = (new Tile(248, "missing_tile", Material::dirt))
                               ->init()
                               ->setDestroyTime(1.0)
                               ->setSoundType(Tile::SOUND_GRAVEL)
                               ->setCategory(1, 1)
                               ->setDescriptionId("info_update");
  Tile::info_updateGame2 = (new Tile(249, "missing_tile", Material::dirt))
                               ->init()
                               ->setDestroyTime(1.0)
                               ->setSoundType(Tile::SOUND_GRAVEL)
                               ->setCategory(1, 1)
  ...
  Tile::fire = (new FireTile(51, "fire"))
                   ->init()
                   ->setDestroyTime(0.0)
                   ->setLightEmission(1.0)
                   ->setSoundType(Tile::SOUND_WOOD)
  ...
  Tile::coloredBrickSlabHalf1 =
      (new ColoredSlabTile(159, 0, 0, "colored_bricks", Material::stone,
                           Tile::SOUND_STONE))
          ->init()
          ->setCategory(6, 1)
          ->setDescriptionId("coloredBrickSlab");
  Tile::coloredBrickSlab1 =
      (new ColoredSlabTile(160, 1, 0, "colored_bricks", Material::stone,
                           Tile::SOUND_STONE))
          ->init()
          ->setCategory(6, 1)
          ->setDescriptionId("coloredBrickSlab");
  Tile::coloredBrickSlabHalf2 =
      (new ColoredSlabTile(161, 0, 8, "colored_bricks", Material::stone,
                           Tile::SOUND_STONE))
          ->init()
          ->setCategory(6, 1)
          ->setDescriptionId("coloredBrickSlab");
  Tile::coloredBrickSlab2 =
      (new ColoredSlabTile(162, 1, 8, "colored_bricks", Material::stone,
                           Tile::SOUND_STONE))
          ->init()
          ->setCategory(6, 1)
          ->setDescriptionId("coloredBrickSlab");

  ((ColoredSlabTile *)Tile::coloredBrickSlabHalf1)->partnerSlabId =
      Tile::coloredBrickSlab1->blockID;
  ((ColoredSlabTile *)Tile::coloredBrickSlab1)->partnerSlabId =
      Tile::coloredBrickSlabHalf1->blockID;
  ((ColoredSlabTile *)Tile::coloredBrickSlabHalf2)->partnerSlabId =
      Tile::coloredBrickSlab2->blockID;
  ((ColoredSlabTile *)Tile::coloredBrickSlab2)->partnerSlabId =
      Tile::coloredBrickSlabHalf2->blockID;

  // Colored stairs
  for (int i = 0; i < 16; i++) {
    char buf[16];
    sprintf(buf, "%d", i);
    Tile::coloredStairs[i] =
        (new StairTile(218 + i, Tile::coloredPlanks, i))
            ->init()
            ->setCategory(6, 1)
  ...
  for (int i = 0; i < 16; i++) {
    char buf[16];
    sprintf(buf, "%d", i);
    Tile::coloredBrickStairs[i] =
        (new StairTile(brick_stair_ids[i], Tile::coloredBricks, i))
            ->init()
            ->setCategory(6, 1)
            ->setDescriptionId("coloredBrickStairs." + std::string(buf));
  }
  ...
  // Colored logs
  int log_ids[16] = {115, 116, 117, 118, 119, 120, 121, 122,
                     125, 127, 129, 130, 131, 132, 133, 137};
  for (int i = 0; i < 16; i++) {
    char buf[16];
    sprintf(buf, "%d", i);
    Tile::coloredLogs[i] =
        (new ColoredLogTile(log_ids[i], i))
            ->init()
            ->setCategory(6, 1)
            ->setDescriptionId("coloredLog." + std::string(buf));
  }

  // Colored slabs
  Tile::coloredSlabHalf1 = (new ColoredSlabTile(234, 0, 0))
                               ->init()
                               ->setCategory(6, 1)
                               ->setDescriptionId("coloredSlab");
  Tile::coloredSlab1 = (new ColoredSlabTile(235, 1, 0))
                           ->init()
                           ->setCategory(6, 1)
                           ->setDescriptionId("coloredSlab");
  Tile::coloredSlabHalf2 = (new ColoredSlabTile(236, 0, 8))
                               ->init()
                               ->setCategory(6, 1)
                               ->setDescriptionId("coloredSlab");
  Tile::coloredSlab2 = (new ColoredSlabTile(237, 1, 8))
                           ->init()
                           ->setCategory(6, 1)
                           ->setDescriptionId("coloredSlab");

  ((ColoredSlabTile *)Tile::coloredSlabHalf1)->partnerSlabId =
      Tile::coloredSlab1->blockID;
  ((ColoredSlabTile *)Tile::coloredSlab1)->partnerSlabId =
      Tile::coloredSlabHalf1->blockID;
  ((ColoredSlabTile *)Tile::coloredSlabHalf2)->partnerSlabId =
      Tile::coloredSlab2->blockID;
  ((ColoredSlabTile *)Tile::coloredSlab2)->partnerSlabId =
      Tile::coloredSlabHalf2->blockID;

  Tile::dirtSlabHalf = (new CustomSlabTile(167, 0, 0))
                           ->init()
                           ->setCategory(1, 1)
                           ->setDescriptionId("dirtSlab");
  Tile::dirtSlab = (new CustomSlabTile(168, 1, 0))
                       ->init()
                       ->setCategory(1, 1)
                       ->setDescriptionId("dirtSlab");
  ((CustomSlabTile *)Tile::dirtSlabHalf)->partnerSlabId =
      Tile::dirtSlab->blockID;
  ((CustomSlabTile *)Tile::dirtSlab)->partnerSlabId =
      Tile::dirtSlabHalf->blockID;

  Tile::grassSlabHalf = (new CustomSlabTile(169, 0, 1))
                            ->init()
                            ->setCategory(1, 1)
                            ->setDescriptionId("grassSlab");
  Tile::grassSlab = (new CustomSlabTile(172, 1, 1))
                        ->init()
                        ->setCategory(1, 1)
                        ->setDescriptionId("grassSlab");
  ((CustomSlabTile *)Tile::grassSlabHalf)->partnerSlabId =
      Tile::grassSlab->blockID;
  ((CustomSlabTile *)Tile::grassSlab)->partnerSlabId =
      Tile::grassSlabHalf->blockID;

  Tile::rockSlabHalf = (new CustomSlabTile(253, 0, 2))
                           ->init()
                           ->setCategory(1, 1)
                           ->setDescriptionId("stoneSlab");
  Tile::rockSlab = (new CustomSlabTile(254, 1, 2))
                       ->init()
                       ->setCategory(1, 1)
                       ->setDescriptionId("stoneSlab");
  ((CustomSlabTile *)Tile::rockSlabHalf)->partnerSlabId =
      Tile::rockSlab->blockID;
  ((CustomSlabTile *)Tile::rockSlab)->partnerSlabId =
      Tile::rockSlabHalf->blockID;

  Item::items[Tile::cloth->blockID] =
      (new ClothTileItem(Tile::cloth->blockID - 256))
          ->setCategory(2, 1)
          ->setDescriptionId("cloth");
  Item::items[Tile::coloredPlanks->blockID] =
      (new ColoredPlanksTileItem(Tile::coloredPlanks->blockID - 256))
          ->setCategory(6, 1)
          ->setDescriptionId("coloredPlanks");
  Item::items[Tile::coloredBricks->blockID] =
      (new ColoredBricksTileItem(Tile::coloredBricks->blockID - 256))
          ->setCategory(6, 1)
          ->setDescriptionId("coloredBricks");
  ...
  for (int i = 0; i < 16; i++) {
    char buf[16];
    sprintf(buf, "%d", i);
    Item::items[Tile::coloredStairs[i]->blockID] =
        (new TileItem(Tile::coloredStairs[i]->blockID - 256))
            ->setCategory(6, 1)
            ->setDescriptionId("coloredStairs." + std::string(buf));

    Item::items[Tile::coloredFences[i]->blockID] =
        (new TileItem(Tile::coloredFences[i]->blockID - 256))
            ->setCategory(6, 1)
            ->setDescriptionId("coloredFence." + std::string(buf));

    Item::items[Tile::coloredLogs[i]->blockID] =
        (new AuxDataTileItem(Tile::coloredLogs[i]->blockID - 256,
                             Tile::coloredLogs[i]))
            ->setCategory(6, 1)
            ->setDescriptionId("coloredLog." + std::string(buf));
  }

  Item::items[Tile::coloredSlabHalf1->blockID] =
      (new ColoredSlabTile::Item(
           Tile::coloredSlabHalf1->blockID - 256, Tile::coloredSlabHalf1,
           Tile::coloredSlabHalf1->blockID, Tile::coloredSlab1->blockID))
          ->setCategory(6, 1)
          ->setDescriptionId("coloredSlab");
  Item::items[Tile::coloredSlabHalf2->blockID] =
      (new ColoredSlabTile::Item(
           Tile::coloredSlabHalf2->blockID - 256, Tile::coloredSlabHalf2,
           Tile::coloredSlabHalf2->blockID, Tile::coloredSlab2->blockID))
          ->setCategory(6, 1)
          ->setDescriptionId("coloredSlab");
  Item::items[Tile::treeTrunk->blockID] =
      (new AuxDataTileItem(Tile::treeTrunk->blockID - 256, Tile::treeTrunk))
          ->setCategory(1, 1)
          ->setDescriptionId("log");
  Item::items[Tile::stoneBrickSmooth->blockID] =
      (new AuxDataTileItem(Tile::stoneBrickSmooth->blockID - 256,
                           Tile::stairs_stoneBrickSmooth))
          ->setCategory(1, 1)
          ->setDescriptionId("stonebricksmooth");
  Item::items[Tile::stoneSlabHalf->blockID] =
      (new StoneSlabTileItem(Tile::stoneSlabHalf->blockID - 256))
          ->setCategory(1, 1)
          ->setDescriptionId("stoneSlab");
  Item::items[Tile::sapling->blockID] =
      (new SaplingTileItem(Tile::sapling->blockID - 256))
          ->setCategory(2, 1)
          ->setDescriptionId("sapling");
  Item::items[Tile::leaves->blockID] =
      (new LeafTileItem(Tile::leaves->blockID - 256))
          ->setCategory(2, 8)
          ->setDescriptionId("leaves");
  Item::items[Tile::sandStone->blockID] =
      (new AuxDataTileItem(Tile::sandStone->blockID - 256, Tile::sandStone))
          ->setCategory(1, 1)
          ->setDescriptionId("sandStone");
  Item::items[Tile::woodSlabHalf->blockID] =
      (new WoodSlabTile::Item(Tile::woodSlabHalf->blockID - 256,
                              Tile::woodSlabHalf))
          ->setCategory(1, 1)
          ->setDescriptionId("woodSlab");
  Item::items[Tile::wood->blockID] =
      (new AuxDataTileItem(Tile::wood->blockID - 256, Tile::wood))
          ->setCategory(1, 1)
          ->setDescriptionId("wood");
  Item::items[Tile::quartzBlock->blockID] =
      (new AuxDataTileItem(Tile::quartzBlock->blockID - 256, Tile::quartzBlock))
          ->setCategory(1, 1)
          ->setDescriptionId("quartzBlock");
  Item::items[Tile::cobbleWall->blockID] =
      (new AuxDataTileItem(Tile::cobbleWall->blockID - 256, Tile::cobbleWall))
          ->setCategory(2, 1)
          ->setDescriptionId("cobbleWall");
  Item::items[Tile::tallgrass->blockID] =
      (new AuxDataTileItem(Tile::tallgrass->blockID - 256, Tile::tallgrass))
          ->setCategory(2, 8)
          ->setDescriptionId("tallgrass");
  Item::items[Tile::woolCarpet->blockID] =
      (new AuxDataTileItem(Tile::woolCarpet->blockID - 256, Tile::woolCarpet))
          ->setCategory(2, 8)
          ->setDescriptionId("woolCarpet");
  Item::items[Tile::doublePlant->blockID] =
      (new DoublePlantTileItem(Tile::doublePlant->blockID - 256))
          ->setCategory(2, 8)
          ->setDescriptionId("doublePlant");
  Item::items[Tile::flowerPaeonia->blockID] =
      (new TileItem(Tile::flowerPaeonia->blockID - 256))
          ->setCategory(2, 8)
          ->setDescriptionId("flowerPaeonia");
  Item::items[Tile::flowerDaisy->blockID] =
      (new TileItem(Tile::flowerDaisy->blockID - 256))
          ->setCategory(2, 8)
          ->setDescriptionId("flowerDaisy");
  Item::items[Tile::flowerHoustonia->blockID] =
      (new TileItem(Tile::flowerHoustonia->blockID - 256))
          ->setCategory(2, 8)
          ->setDescriptionId("flowerHoustonia");
  Item::items[Tile::flowerOrchid->blockID] =
      (new TileItem(Tile::flowerOrchid->blockID - 256))
          ->setCategory(2, 8)
          ->setDescriptionId("flowerOrchid");
  Item::items[Tile::flowerAllium->blockID] =
      (new TileItem(Tile::flowerAllium->blockID - 256))
          ->setCategory(2, 8)
          ->setDescriptionId("flowerAllium");
  Item::items[Tile::waterLily->blockID] =
      (new WaterLilyTileItem(Tile::waterLily->blockID - 256))
          ->setCategory(2, 8)
          ->setDescriptionId("waterlily");
  Item::items[Tile::seagrass->blockID] =
  ...
  Item::items[Tile::stainedGlass->blockID] =
      (new AuxDataTileItem(Tile::stainedGlass->blockID - 256,
          ...
          ->setCategory(5, 1)
          ->setDescriptionId("stainedGlass");
  Item::items[Tile::stainedGlassPane->blockID] =
      (new AuxDataTileItem(Tile::stainedGlassPane->blockID - 256,
                           Tile::stainedGlassPane))
          ->setCategory(5, 1)
          ->setDescriptionId("stainedGlassPane");
  Item::items[Tile::dirtSlabHalf->blockID] =
      (new CustomSlabTile::Item(Tile::dirtSlabHalf->blockID - 256,
                                Tile::dirtSlabHalf, Tile::dirtSlabHalf->blockID,
                                Tile::dirtSlab->blockID))
          ->setCategory(1, 1)
          ->setDescriptionId("dirtSlab");
  Item::items[Tile::grassSlabHalf->blockID] =
      (new CustomSlabTile::Item(
           Tile::grassSlabHalf->blockID - 256, Tile::grassSlabHalf,
           Tile::grassSlabHalf->blockID, Tile::grassSlab->blockID))
          ->setCategory(1, 1)
          ->setDescriptionId("grassSlab");
  Item::items[Tile::rockSlabHalf->blockID] =
      (new CustomSlabTile::Item(Tile::rockSlabHalf->blockID - 256,
                                Tile::rockSlabHalf, Tile::rockSlabHalf->blockID,
                                Tile::rockSlab->blockID))
          ->setCategory(1, 1)
          ->setDescriptionId("stoneSlab");
  ...
  Tile::lightBlock[Tile::dirtSlabHalf->blockID] = 0;
  Tile::lightBlock[Tile::grassSlabHalf->blockID] = 0;
  Tile::lightBlock[Tile::rockSlabHalf->blockID] = 0;
  ...
  for (int i = 0; i < 16; i++) {
    if (Tile::coloredStairs[i])
      Tile::lightBlock[Tile::coloredStairs[i]->blockID] = 0;
    if (Tile::coloredBrickStairs[i])
      Tile::lightBlock[Tile::coloredBrickStairs[i]->blockID] = 0;
    if (Tile::coloredFences[i])
      Tile::lightBlock[Tile::coloredFences[i]->blockID] = 0;
  }
...
TextureUVCoordinateSet Tile::getTextureUVCoordinateSet(const std::string &s,
                                                       int32_t a4) {
  return *Tile::_terrainTextureAtlas->getTextureItem(s)->getUV(a4);
}
bool_t Tile::isFaceVisible(Level *level, int32_t x, int32_t y, int32_t z,
                           int32_t face) {
  switch (face) {
  case 0:
    --y;
...
void Tile::popResource(Level *level, int32_t x, int32_t y, int32_t z,
                       const struct ItemInstance &a6) {
  float xOffset;   // s19
  float yOffset;   // s18
  float zOffset;   // s16
  ItemEntity *v13; // r5
  ...
  if (!level->isClientMaybe) {
    if (level->levelData.getGameType() != 1) {
      ...
      v13 = new ItemEntity(
          level, (float)x + (float)((float)(xOffset * 0.7) + 0.15),
          (float)y + (float)((float)(yOffset * 0.7) + 0.15),
          (float)z + (float)((float)(zOffset * 0.7) + 0.15), a6);
...
int32_t Tile::transformToValidBlockId(int32_t oldid, int32_t x, int32_t y,
                                      int32_t z) {
  Tile *v4;
  if (oldid) {
    if (!Tile::tiles[oldid]) {
...
bool_t Tile::isSolidRender() { return 1; }
bool_t Tile::isPathfindable(LevelSource *level, int32_t x, int32_t y,
                            int32_t z) {
  return !this->material->blocksMotion();
}
bool_t Tile::isUnbreakable() { return this->blockHardness < 0; }
bool_t Tile::isLiquidTile() { return 0; }
int32_t Tile::getTileEntityType(void) { return 0; }
bool_t Tile::mayPick() { return 1; }
bool_t Tile::mayPick(int32_t, bool_t) { return this->mayPick(); }
...
int32_t Tile::getTickDelay() { return 10; }
...
void Tile::playerWillDestroy(Level *, int32_t, int32_t, int32_t, int32_t,
                             Player *) {}
void Tile::neighborChanged(Level *level, int32_t x, int32_t y, int32_t z,
                           int32_t nx, int32_t ny, int32_t nz, int32_t nid) {
...
void Tile::onGraphicsModeChanged(bool_t a2) { this->goodGraphics = a2; }
int32_t Tile::getResource(int32_t, Random *) { return this->blockID; }
int32_t Tile::getResourceCount(Random *) { return 1; }
...
void Tile::spawnResources(Level *level, int32_t x, int32_t y, int32_t z,
                          int32_t meta) {
  return this->spawnResources(level, x, y, z, meta, 1.0);
}
void Tile::spawnResources(Level *a2, int32_t a3, int32_t a4, int32_t a5,
                          int32_t a6, float a7) {
  CushionManager::onTileDestroyed(a2, a3, a4, a5);
  int i;            // r7
  Random *p_random; // r4
  int v13;          // r11
  int v14;          // r10
    ...
    while (i < v13) {
      if (p_random->nextFloat() <= a7) {
        ...
        if (v14 > 0) {
          ...
          v19 = new ItemEntity(a2, (float)a3 + (float)((float)(f * 0.7) + 0.15),
                               (float)a4 + (float)((float)(f1 * 0.7) + 0.15),
                               (float)a5 + (float)((float)(f2 * 0.7) + 0.15),
                               ItemInstance(v14, 1, v18));
...
bool_t Tile::spawnBurnResources(Level *, float, float, float) { return 0; }
float Tile::getExplosionResistance(Entity *e) {
  return this->blockResistance / 5.0;
}
HitResult Tile::clip(Level *level, int32_t x, int32_t y, int32_t z,
                     const Vec3 &a7, const Vec3 &a8) {
  bool_t v9;  // r5
  bool_t v10; // s19
  Vec3 *v11;  // r4
  bool_t v12; // s19
...
int32_t Tile::getRenderLayer() { return 0; }
bool_t Tile::use(Level *, int32_t, int32_t, int32_t, Player *) { return 0; }
void Tile::stepOn(Level *, int32_t, int32_t, int32_t, Entity *) {}
void Tile::fallOn(Level *, int32_t, int32_t, int32_t, Entity *, float) {}
int32_t Tile::getPlacementDataValue(Level *level, int32_t x, int32_t y,
                                    int32_t z, int32_t a6, float a7, float a8,
                                    float a9, struct Mob *a10, int32_t a11) {
  return a11;
}
void Tile::prepareRender(Level *, int32_t, int32_t, int32_t) {}
void Tile::attack(Level *, int32_t, int32_t, int32_t, Player *) {}
void Tile::handleEntityInside(Level *, int32_t, int32_t, int32_t, Entity *,
                              Vec3 &) {}
int32_t Tile::getColor(int32_t) { return 0xffffffff; }
int32_t Tile::getColor(LevelSource *level, int32_t x, int32_t y, int32_t z) {
  return 0xffffff;
}
float Tile::getThickness() { return 0; }
bool_t Tile::isSignalSource() { return 0; }
int32_t Tile::getSignal(LevelSource *, int32_t, int32_t, int32_t) { return 0; }
...
void Tile::playerDestroy(Level *level, Player *player, int32_t x, int32_t y,
                         int32_t z, int32_t a7) {
  return this->spawnResources(level, x, y, z, a7);
}
bool_t Tile::canSurvive(Level *, int32_t, int32_t, int32_t) { return 1; }
std::string Tile::getName() {
  return I18n::get(this->getDescriptionId() + ".name");
}
std::string Tile::getDescriptionId(void) { return this->descriptionId; }
std::string Tile::getDescriptionId(const struct ItemInstance *) {
  return this->getDescriptionId();
}
std::string Tile::getTypeDescriptionId(int32_t) { return ""; }
...
void Tile::setTicking(bool_t a2) { Tile::shouldTick[this->blockID] = a2; }
int32_t Tile::getSpawnResourcesAuxValue(int32_t) { return 0; }
Tile *Tile::init() {
  int32_t v4;
  Tile::tiles[this->blockID] = this;
  this->setShape(this->minX, this->minY, this->minZ, this->maxX, this->maxY,
                 this->maxZ);
  Tile::solid[this->blockID] = this->isSolidRender();
  if (this->isSolidRender())
    v4 = 255;
  else
    v4 = 0;
...
bool_t Tile::isBed(int32_t tileID) {
  if (Tile::bed && tileID == Tile::bed->blockID)
    return 1;
  for (int32_t i = 0; i < 16; ++i) {
    if (Tile::coloredBeds[i] && tileID == Tile::coloredBeds[i]->blockID)
      return 1;
  }
  return 0;
}
