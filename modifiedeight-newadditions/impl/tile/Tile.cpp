...
void Tile::initTiles(std::shared_ptr<TextureAtlas> a1) {
	...
	Tile::stainedGlassPane = (new StainedGlassPaneTile(196, "glass_white", "glass_pane_top_shared", Material::glass, 0))->init()->setDestroyTime(0.3)->setSoundType(Tile::SOUND_GLASS)->setCategory(5, 1)->setDescriptionId("stainedGlassPane");
	...
	Tile::coloredPlanks = (new ColoredPlanksTile(217))->init()->setDestroyTime(2.0)->setExplodeable(5.0)->setSoundType(Tile::SOUND_WOOD)->setCategory(6, 1)->setDescriptionId("coloredPlanks");
	...
	Tile::fence_spruce = (new SpruceFenceTile(197))->init()->setDestroyTime(2.0)->setExplodeable(5.0)->setSoundType(Tile::SOUND_WOOD)->setCategory(5, 1)->setDescriptionId("fence_spruce");
	Tile::fence_birch = (new BirchFenceTile(198))->init()->setDestroyTime(2.0)->setExplodeable(5.0)->setSoundType(Tile::SOUND_WOOD)->setCategory(5, 1)->setDescriptionId("fence_birch");
	
	Tile::trapdoor_spruce = (new TrapDoorTile(199, "trapdoor_spruce", Material::wood))->init()->setDestroyTime(3.0)->setSoundType(Tile::SOUND_WOOD)->setCategory(5, 1)->setDescriptionId("trapdoor_spruce");
	Tile::trapdoor_birch = (new TrapDoorTile(200, "trapdoor_birch", Material::wood))->init()->setDestroyTime(3.0)->setSoundType(Tile::SOUND_WOOD)->setCategory(5, 1)->setDescriptionId("trapdoor_birch");
	
	for(int i = 0; i < 16; i++) {
		Tile::coloredBeds[i] = (new ColoredBedTile(201 + i, i))->init()->setDestroyTime(0.2)->setSoundType(Tile::SOUND_WOOD)->setCategory(5, 1)->setDescriptionId("bed");
	}
	...
	Tile::door_spruce = (new DoorTile(193, Material::wood, "door_spruce"))->init()->setDestroyTime(3.0)->setSoundType(Tile::SOUND_WOOD)->setCategory(2, 1)->setDescriptionId("doorSpruce");
	Tile::door_birch = (new DoorTile(194, Material::wood, "door_birch"))->init()->setDestroyTime(3.0)->setSoundType(Tile::SOUND_WOOD)->setCategory(2, 1)->setDescriptionId("doorBirch");
	...
	Tile::coloredBrickSlabHalf1 = (new ColoredSlabTile(159, 0, 0, "colored_bricks", Material::stone, Tile::SOUND_STONE))
		->init()->setCategory(6, 1)->setDescriptionId("coloredBrickSlab");
	Tile::coloredBrickSlab1 = (new ColoredSlabTile(160, 1, 0, "colored_bricks", Material::stone, Tile::SOUND_STONE))
		->init()->setCategory(6, 1)->setDescriptionId("coloredBrickSlab");
	Tile::coloredBrickSlabHalf2 = (new ColoredSlabTile(161, 0, 8, "colored_bricks", Material::stone, Tile::SOUND_STONE))
		->init()->setCategory(6, 1)->setDescriptionId("coloredBrickSlab");
	Tile::coloredBrickSlab2 = (new ColoredSlabTile(162, 1, 8, "colored_bricks", Material::stone, Tile::SOUND_STONE))
		->init()->setCategory(6, 1)->setDescriptionId("coloredBrickSlab");

	((ColoredSlabTile*)Tile::coloredBrickSlabHalf1)->partnerSlabId = Tile::coloredBrickSlab1->blockID;
	((ColoredSlabTile*)Tile::coloredBrickSlab1)->partnerSlabId = Tile::coloredBrickSlabHalf1->blockID;
	((ColoredSlabTile*)Tile::coloredBrickSlabHalf2)->partnerSlabId = Tile::coloredBrickSlab2->blockID;
	((ColoredSlabTile*)Tile::coloredBrickSlab2)->partnerSlabId = Tile::coloredBrickSlabHalf2->blockID;

	// Colored stairs
	for (int i = 0; i < 16; i++) {
		char buf[16];
		sprintf(buf, "%d", i);
		Tile::coloredStairs[i] = (new StairTile(218 + i, Tile::coloredPlanks, i))
			->init()
			->setCategory(6, 1)
			->setDescriptionId("coloredStairs." + std::string(buf));
	}

	int brick_stair_ids[16] = {
	...
	for (int i = 0; i < 16; i++) {
		char buf[16];
		sprintf(buf, "%d", i);
		Tile::coloredBrickStairs[i] = (new StairTile(brick_stair_ids[i], Tile::coloredBricks, i))
			->init()
			->setCategory(6, 1)
	...
	for (int i = 0; i < 16; i++) {
		char buf[16];
		sprintf(buf, "%d", i);
		Tile::coloredFences[i] = (new ColoredFenceTile(174 + i, i))
			->init()
			->setCategory(6, 1)
	...
	for (int i = 0; i < 16; i++) {
		char buf[16];
		sprintf(buf, "%d", i);
		Tile::coloredLogs[i] = (new ColoredLogTile(log_ids[i], i))
			->init()
			->setCategory(6, 1)
	...
	((ColoredSlabTile*)Tile::coloredSlabHalf1)->partnerSlabId = Tile::coloredSlab1->blockID;
	((ColoredSlabTile*)Tile::coloredSlab1)->partnerSlabId = Tile::coloredSlabHalf1->blockID;
	((ColoredSlabTile*)Tile::coloredSlabHalf2)->partnerSlabId = Tile::coloredSlab2->blockID;
	((ColoredSlabTile*)Tile::coloredSlab2)->partnerSlabId = Tile::coloredSlabHalf2->blockID;

	Item::items[Tile::cloth->blockID] = (new ClothTileItem(Tile::cloth->blockID - 256))->setCategory(2, 1)->setDescriptionId("cloth");
	Item::items[Tile::coloredPlanks->blockID] = (new ColoredPlanksTileItem(Tile::coloredPlanks->blockID - 256))->setCategory(6, 1)->setDescriptionId("coloredPlanks");
	Item::items[Tile::coloredBricks->blockID] = (new ColoredBricksTileItem(Tile::coloredBricks->blockID - 256))->setCategory(6, 1)->setDescriptionId("coloredBricks");

	// Register items for colored variants
	for (int i = 0; i < 16; i++) {
		char buf[16];
		sprintf(buf, "%d", i);
		Item::items[Tile::coloredStairs[i]->blockID] = (new TileItem(Tile::coloredStairs[i]->blockID - 256))
			->setCategory(6, 1)
			->setDescriptionId("coloredStairs." + std::string(buf));

		Item::items[Tile::coloredFences[i]->blockID] = (new TileItem(Tile::coloredFences[i]->blockID - 256))
			->setCategory(6, 1)
			->setDescriptionId("coloredFence." + std::string(buf));

		Item::items[Tile::coloredLogs[i]->blockID] = (new AuxDataTileItem(Tile::coloredLogs[i]->blockID - 256, Tile::coloredLogs[i]))
			->setCategory(6, 1)
			->setDescriptionId("coloredLog." + std::string(buf));
	}

	Item::items[Tile::coloredSlabHalf1->blockID] = (new ColoredSlabTile::Item(Tile::coloredSlabHalf1->blockID - 256, Tile::coloredSlabHalf1, Tile::coloredSlabHalf1->blockID, Tile::coloredSlab1->blockID))
		->setCategory(6, 1)
		->setDescriptionId("coloredSlab");
	Item::items[Tile::coloredSlabHalf2->blockID] = (new ColoredSlabTile::Item(Tile::coloredSlabHalf2->blockID - 256, Tile::coloredSlabHalf2, Tile::coloredSlabHalf2->blockID, Tile::coloredSlab2->blockID))
		->setCategory(6, 1)
		->setDescriptionId("coloredSlab");
...
bool_t Tile::isBed(int32_t tileID) {
	if(Tile::bed && tileID == Tile::bed->blockID) return 1;
	for(int32_t i = 0; i < 16; ++i) {
		if(Tile::coloredBeds[i] && tileID == Tile::coloredBeds[i]->blockID) return 1;
	}
	return 0;
}
