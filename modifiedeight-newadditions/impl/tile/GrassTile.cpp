	...
	if (level) {
		...
		for (int sx = -1; sx <= 1; ++sx) {
			for (int sz = -1; sz <= 1; ++sz) {
				...
				else if (b == Biome::jungle) c = 0x59C93C;
				else if (b == Biome::rainForest) c = 0x53C842;
				else if (b == Biome::equatorialRainforest) c = 0x3DBA30;
				else if (b == Biome::taiga) c = 0x86B783;
				else if (b == Biome::tundra) c = 0x80B497;
				else if (b == Biome::icePeaks) c = 0x74B8A8;
				else if (b == Biome::iceDesert) c = 0x8EB09B;
				else if (b == Biome::savanna) c = 0xBFB755;
				else if (b == Biome::desert) c = 0xBFA243;
				else if (b == Biome::shrubland) c = 0x9EB650;
				else if (b == Biome::mountain) c = 0x70B268;
				totalR += (c >> 16) & 0xFF;
				totalG += (c >> 8) & 0xFF;
				totalB += c & 0xFF;
			}
