	...
	if(this->noclip) {
		...
		if(stepHeight > 0.0 && (fallingFlag || this->isInWater()) && this->ySize < 0.05 && (movX != v43 || movZ != v42)) {
			...
			if ((v42 * v42 + v43 * v43) < (curStepZ * curStepZ + curStepX * curStepX)) {
				this->ySize = (float)(this->ySize + curStepY - movY);
				v42 = curStepZ;
				v43 = curStepX;
				v36 = curStepY;
			} else {
		...
		if(field_110 && !v34) {
			...
			if(field_BC > (float)this->field_114) {
				this->field_114 = (int32_t)field_BC + 1;
				if(this->isInWater()) {
					this->level->playSound(this, "liquid.swim", 0.35f, 1.0f + (Entity::sharedRandom.nextFloat() - Entity::sharedRandom.nextFloat()) * 0.4f);
				} else if(v90 > 0) {
...
void Entity::push(Entity* a2) {
	...
	if(a2->rider != this && a2->ridingAt != this) {
		if ((this->isPlayer() && a2 && (a2->getEntityTypeId() == 15 || a2->getEntityTypeId() == 120)) ||
			((this->getEntityTypeId() == 15 || this->getEntityTypeId() == 120) && a2 && a2->isPlayer())) {
			return;
		}
