...
std::vector<ItemInstance>
    CreativeInventoryScreen::filteredItems[CreativeInventoryScreen::NUM_TABS];

CreativeInventoryScreen::TabButtonWithMeta::TabButtonWithMeta(
    int f0, std::shared_ptr<ImageButton> f4)
    : field_0(f0), field_4(std::move(f4)) {}
CreativeInventoryScreen::TabButtonWithMeta::TabButtonWithMeta(
    const CreativeInventoryScreen::TabButtonWithMeta &a2)
    : field_0(a2.field_0), field_4(a2.field_4) {}
CreativeInventoryScreen::TabButtonWithMeta::TabButtonWithMeta(
    CreativeInventoryScreen::TabButtonWithMeta &&a2)
...
void CreativeInventoryScreen::closeWindow() { this->minecraft->setScreen(0); }
std::shared_ptr<ImageButton>
CreativeInventoryScreen::createInventoryTabButton(int32_t a3, int32_t a4,
                                                  bool isRightSide) {
  NinePatchLayer *patch =
      isRightSide ? this->rightTabPatch.get() : this->field_70.get();
  std::shared_ptr<ImageButton> res(
      new CategoryButton(a3, patch, patch, &this->field_A4));
  res->height = this->field_58;
  res->width = this->field_58;
  res->setOverrideScreenRendering(1);
  return res;
}
void CreativeInventoryScreen::drawIcon(int a2, std::shared_ptr<ImageButton> a3,
                                       bool_t a4, bool_t a5) {
  ...
  ItemRenderer::renderGuiItemNew(this->minecraft->texturesPtr, &v14, 0,
                                 (float)(a3->posX + v9 / 2 - 8) + 1.0, v11, 1.0,
                                 v12, v13);
}
int32_t
CreativeInventoryScreen::getCategoryFromPanel(const Touch::InventoryPane *a2) {
...
ItemInstance CreativeInventoryScreen::getItemFromType(int32_t a3) {
  ...
  case 5:
    return Tile::flowerOrchid
               ? ItemInstance(Tile::flowerOrchid)
               : (Tile::rose ? ItemInstance(Tile::rose) : ItemInstance());
  case 6:
    return Tile::redstoneLampOff
               ? ItemInstance(Tile::redstoneLampOff)
               : (Tile::lever ? ItemInstance(Tile::lever) : ItemInstance());
  case 7:
    return Item::mobPlacer ? ItemInstance(Item::mobPlacer, 1, 33)
                           : ItemInstance();
  case 8:
    return Tile::cloth ? ItemInstance(Tile::cloth, 1, 11) : ItemInstance();
  case 9:
    return Tile::glowingObsidian
               ? ItemInstance(Tile::glowingObsidian)
               : (Tile::netherReactor ? ItemInstance(Tile::netherReactor)
                                      : ItemInstance());
  default:
    return Tile::redBrick ? ItemInstance(Tile::redBrick) : ItemInstance();
  }
...
void CreativeInventoryScreen::populateFilteredItems() {
  ...
  // TAB 0: Building Blocks (Bricks icon)
  ...
  // TAB 1: Decorative Blocks (Bookshelf icon)
  ...
  addTabItem(7, Tile::trapdoor_jungle);
  ...
  addTabItem(7, Tile::fence_jungle);
  ...
  addTabItem(7, Tile::stoneBrickWall);
  addTabItem(7, Tile::mossyStoneBrickWall);
  addTabItem(7, Tile::crackedStoneBrickWall);
  addTabItem(7, Tile::brickWall);
  addTabItem(7, Tile::sandstoneWall);
  addTabItem(7, Tile::quartzWall);
  addTabItem(7, Tile::chiseledQuartzWall);
  addTabItem(7, Tile::oakWall);
  addTabItem(7, Tile::spruceWall);
  addTabItem(7, Tile::birchWall);
  addTabItem(7, Tile::jungleWall);
  addTabItem(7, Tile::ironWall);
  addTabItem(7, Tile::copperWall);
  addTabItem(7, Tile::web);
  addTabItem(7, Tile::head_steve);
  addTabItem(7, Tile::head_skeleton);
  addTabItem(7, Tile::head_zombie);
  addTabItem(7, Tile::head_creeper);
  ...
  addTabItem(7, Tile::head_chicken);
  addTabItem(7, Tile::head_villager);
  addTabItem(7, Tile::head_ocelot);
  addTabItem(7, Tile::head_polarbear);
  addTabItem(7, Tile::head_turtle);
  addTabItem(7, Tile::head_wolf);
  addTabItem(7, Tile::head_fox);

  // TAB 2: Tools, Weapons & Armor (Sword icon)
  ...
  addTabItem(6, Item::boat, 1, 0);
  addTabItem(6, Item::boat, 1, 1);
  addTabItem(6, Item::boat, 1, 2);
  addTabItem(6, Item::boat, 1, 3);
  addTabItem(6, Item::bucket, 1, 0);
  if (Tile::water)
    addTabItem(6, Item::bucket, 1, Tile::water->blockID);
  if (Tile::lava)
    addTabItem(6, Item::bucket, 1, Tile::lava->blockID);
  ...
  // TAB 4: Materials & Items (Seed icon)
  ...
  // TAB 5: Vegetation (Blue Orchid icon)
  for (int j = 0; j < 4; ++j) {
  ...
  // TAB 6: Redstone / Mechanisms (Redstone Lamp icon)
  addTabItem(1, Tile::redstoneLampOff);
  addTabItem(1, Tile::copperBulb);
  ...
  // TAB 8: Advanced (Glowing Obsidian icon)
  ...
  if (Tile::water)
    addTabItem(3, Tile::water);
  if (Tile::lava)
    addTabItem(3, Tile::lava);
  if (Tile::fire)
    addTabItem(3, Tile::fire);
}
...
void CreativeInventoryScreen::render(int32_t a2, int32_t a3, float a4) {
  ...
  std::shared_ptr<Touch::InventoryPane> v25 =
      this->field_78[this->currentPaneMaybe];
  this->fill(v25->field_228.minX - this->field_B8 - v25->field_248,
             v25->field_228.minY - v25->field_24C,
             v25->field_228.minX - v25->field_248,
             v25->field_228.height + v25->field_228.minY + v25->field_24C,
             0xFF333333);
  int v15 = v25->field_228.minX + v25->field_228.width + v25->field_248;
  this->fill(v15, v25->field_228.minY - v25->field_24C, v15 + this->field_B8,
             v25->field_228.minY + v25->field_228.height + v25->field_24C,
             0xFF333333);
  v25->render(a2, a3, a4);
  ...
  if (this->armorButton) {
    ...
    float v11 =
        (float)((float)this->armorButton->posY + (float)(v10 * 0.5f)) - 8.0f;
    ItemInstance chestplate(Item::chestplate_iron);
    ItemRenderer::renderGuiItemNew(
        this->minecraft->texturesPtr, &chestplate, 0,
        (float)(this->armorButton->posX + v9 / 2 - 8) + 1.0f, v11, 1.0f, 1.0f,
        v13);
  }
  for (const auto &v27 : this->field_98) {
    if (v27.field_4.get() == this->field_A4) {
  ...
  this->minecraft->gui.renderOnSelectItemNameText(
      this->width, this->minecraft->font, this->height - 19);
}
void CreativeInventoryScreen::init() {
  ...
  this->field_68 = std::shared_ptr<NinePatchLayer>(
      v16.createSymmetrical(IntRectangle{34, 43, 14, 14}, 3, 3, 14, 14));
  ...
  this->field_58 = v4;
  IntRectangle a5 = {this->minecraft->options.leftHanded ? 65 : 49,
                     this->minecraft->options.leftHanded ? 55 : 43, 14, 14};
  IntRectangle a5_right = {this->minecraft->options.leftHanded ? 49 : 65,
                           this->minecraft->options.leftHanded ? 43 : 55, 14,
                           14};
  this->field_70 =
      std::shared_ptr<NinePatchLayer>(v16.createSymmetrical(a5, 3, 3, v4, v4));
  this->rightTabPatch = std::shared_ptr<NinePatchLayer>(
      v16.createSymmetrical(a5_right, 3, 3, v4, v4));
  this->field_98.clear();
  this->field_98.emplace_back(CreativeInventoryScreen::TabButtonWithMeta(
      5, this->createInventoryTabButton(10, 5, false)));
  this->field_98.emplace_back(CreativeInventoryScreen::TabButtonWithMeta(
      6, this->createInventoryTabButton(11, 6, false)));
  this->field_98.emplace_back(CreativeInventoryScreen::TabButtonWithMeta(
      8, this->createInventoryTabButton(14, 8, false)));
  if (this->minecraft->options.extendedInventory) {
    this->field_98.emplace_back(CreativeInventoryScreen::TabButtonWithMeta(
        9, this->createInventoryTabButton(15, 9, false)));
  }
  this->field_98.emplace_back(CreativeInventoryScreen::TabButtonWithMeta(
      4, this->createInventoryTabButton(9, 4, true)));
  this->field_98.emplace_back(CreativeInventoryScreen::TabButtonWithMeta(
      7, this->createInventoryTabButton(13, 7, true)));
  this->field_98.emplace_back(CreativeInventoryScreen::TabButtonWithMeta(
      3, this->createInventoryTabButton(8, 3, true)));
  this->field_98.emplace_back(CreativeInventoryScreen::TabButtonWithMeta(
      2, this->createInventoryTabButton(7, 2, true)));
  this->field_98.emplace_back(CreativeInventoryScreen::TabButtonWithMeta(
      1, this->createInventoryTabButton(6, 1, true)));
  ...
  v5->init(this->minecraft->texturesPtr, this->field_58, this->field_58, a5, a5,
  ...
  vArmor->init(this->minecraft->texturesPtr, this->field_58, this->field_58,
               a5_right, a5_right, 2, 2, "gui/spritesheet.png");
...
void CreativeInventoryScreen::setupPositions() {
  this->field_68->setSize((float)((float)this->width - 4.0) -
                              (float)this->field_58 * 2.0f,
                          (float)this->height - 25.0);
  ...
  for (int i = 0; i < leftCount && i < (int)this->field_98.size(); ++i) {
    ...
    this->field_98[i].field_4->posY = this->field_AC + this->field_58 +
                                      this->field_5C +
                                      i * (this->field_58 + this->field_5C);
  ...
  for (size_t j = leftCount; j < this->field_98.size(); ++j) {
    ...
    this->field_98[j].field_4->posY =
        this->field_AC + this->field_58 + this->field_5C +
        (int)(j - leftCount) * (this->field_58 + this->field_5C);
  ...
  if (!this->field_78[0].get()) {
    ...
    for (size_t i = 0; i < this->field_98.size(); ++i) {
      ...
      this->field_78[i] =
          std::shared_ptr<Touch::InventoryPane>(new Touch::InventoryPane(
              this, this->minecraft, r3_0, r3_0.width, 1, count, 26, 1, 0));
    }
  }
}
...
void CreativeInventoryScreen::tick() {
  if (this->currentPaneMaybe >= 0 && this->currentPaneMaybe < NUM_TABS &&
      this->field_78[this->currentPaneMaybe]) {
...
void CreativeInventoryScreen::mouseClicked(int32_t a2, int32_t a3, int32_t a4) {
  if (a4 == 4 || a4 == 5) {
    if (this->currentPaneMaybe >= 0 && this->currentPaneMaybe < NUM_TABS &&
      ...
      if (newY > 0.0f)
        newY = 0.0f;
      if (newY < (float)pane->field_12C)
        newY = (float)pane->field_12C;
...
void CreativeInventoryScreen::mouseReleased(int32_t a2, int32_t a3,
                                            int32_t a4) {
...
bool_t CreativeInventoryScreen::addItem(const Touch::InventoryPane *a2,
                                        int32_t a3) {
  std::vector<ItemInstance> *v7 =
      &filteredItems[this->getCategoryFromPanel(a2)];
  if (a3 >= v7->size()) {
    return 0;
  }
  ...
  int32_t slot =
      this->minecraft->player->inventory->getLinkedSlotForItemAndAux(id, auxv);
  if (slot < 0 || slot >= this->minecraft->gui.getNumSlots() - 1) {
    ...
    this->minecraft->player->inventory->linkSlot(
        this->minecraft->player->inventory->selectedSlot, v14);
    this->minecraft->player->inventory->setItem(
        this->minecraft->player->inventory->selectedSlot, &v15);
  } else {
    this->minecraft->player->inventory->selectedSlot = slot;
  }
  this->minecraft->gui.resetItemNameOverlay();
  this->minecraft->gui.flashSlot(
      this->minecraft->player->inventory->selectedSlot);
  return 1;
}
bool_t CreativeInventoryScreen::isAllowed(int32_t) { return 1; }
std::vector<const ItemInstance *>
CreativeInventoryScreen::getItems(const Touch::InventoryPane *a3) {
