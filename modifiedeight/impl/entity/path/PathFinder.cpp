...
LABEL_11:
						v8 = 1;
					} else if(!this->field_34 && (v9 == Tile::door_wood->blockID || v9 == Tile::door_spruce->blockID || v9 == Tile::door_birch->blockID)) {
						return 0;
					}
					v14 = Tile::tiles[v9];
					if(!v14->isPathfindable(this->levelSource, v7, v13, v12) && (!this->field_35 || (v10 != Tile::door_wood->blockID && v10 != Tile::door_spruce->blockID && v10 != Tile::door_birch->blockID))) {
