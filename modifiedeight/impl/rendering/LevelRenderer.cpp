...
void LevelRenderer::allChanged() {
	...
	if (renderDistance >= 3) v7 = 64;
	else if (renderDistance == 2) v7 = 128;
	else if (renderDistance == 1) v7 = 256;
	else if (renderDistance == 0) v7 = 384;
	else if (renderDistance == -1) v7 = 512;
	else if (renderDistance == -2) v7 = 768;
	else v7 = 1024;
